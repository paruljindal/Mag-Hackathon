...
export default class ObjectCreator extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      joins: joinTypes,
      logicalOperators: logicalOperatorTypes,
      comparisionOperators: comparisionOperatorTypes
    };
  }
  ...
  render() {
    const { item, objectType, allContent, onOps } = this.props;
